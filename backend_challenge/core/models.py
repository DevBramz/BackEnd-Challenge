...
class RouteSettings(TimeStampedModel):
    ...
    class BranchChoices(models.TextChoices):
        ...
        ibuQA = "Rongai  ", _("Rongai hub )")  # Hardcorded choices for now
    ...
    def save(self, **kwargs):
        ...
        if (
            ...
            and self.finish_time < self.departure_time
        ):
...
class Trip(TimeStampedModel):
    ...
    num_deliveries = models.CharField(
        max_length=100, blank=True, default=1, editable=False
    )
